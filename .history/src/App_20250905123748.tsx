...
<div className="ilustracion-wrapper">
  <img src={imagenActual} alt="Ilustración" className="ilustracion" />

  {/* Código animado palabra por palabra */}
  <div className="codigo-animado">
    <span>function</span>
    <span>hola()</span>
    <span>{'{'}</span>
    <span>console.log("Hola")</span>
    <span>{'}'}</span>
  </div>
</div>
