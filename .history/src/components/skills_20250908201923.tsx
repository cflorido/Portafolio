...
{getVisibleCards().map((category, idx) => {
  ...
  const realIndex = (currentIndex + idx) % categories.length;
  ...
  return (
    <div
      ...
      onClick={() => goToSlide(realIndex)} // <- aquí hacemos que al hacer click se seleccione
    >
