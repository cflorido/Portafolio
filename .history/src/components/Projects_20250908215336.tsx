...
const Projects = () => {
  const proyectos = [
    ...
    ,
    {
      ...
      "descripcion": "A research-focused project that implements and evaluates differential privacy algorithms to perturb mobility trajectories. The solution generates key metrics such as origin-destination matrices and heatmaps, using real trajectory datasets from Beijing to ensure realistic experimentation and analysis.",
