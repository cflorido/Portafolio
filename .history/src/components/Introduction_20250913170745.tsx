...
const getSparkleStyle = (point: any) => {
  ...
  return {
    ...
    height: size,
    opacity: opacity,
    background: `radial-gradient(circle, rgb(247, 193, 193) 0%, rgba(255,255,255,0.7) 50%, transparent 100%)`,
    filter: `drop-shadow(0 0 ${size}px rgb(70, 55, 101))`,
  };
};
    ...
    >
      ...
      <div className="intro-content">
        <p>
          ...
          <span className="highlight">innovation</span>, with a strong interest
          in solving complex problems and building impactful solutions. Skilled
          in software development, data analysis and{" "}
          <span className="highlight">process optimization</span>, and always
