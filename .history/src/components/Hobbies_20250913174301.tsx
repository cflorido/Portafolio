...
import { FaGolfBall, FaPaintBrush, FaBook } from "react-icons/fa"; // Iconos
import { GiKnitting } from "react-icons/gi"; // Icono crochet
import "./Hobbies.css";
...
const Hobbies = () => {
  ...
  return (
    ...
    >
      <div className="trail-container-hobbies">
        {trailPoints.map((point) => (
          <div key={point.id} className="sparkle" style={getSparkleStyle(point)} />
        ))}
      ...
      <div className="intro-content">
        ...
        <div className="hobby-icons">
          <div className="circle"><GiKnitting size={40} /></div>
          <div className="circle"><FaGolfBall size={40} /></div>
          <div className="circle"><FaPaintBrush size={40} /></div>
          <div className="circle"><FaBook size={40} /></div>
        </div>
      </div>
    </section>
  );
